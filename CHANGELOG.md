...
- Добавлен Tailscale compatibility block: tailnet `100.64.0.0/10`, IPv6 ULA `fd7a:115c:a1e0::/48`, DNS `100.100.100.100` и домены `ts.net`/`tailscale.com` идут напрямую, чтобы Shadowrocket не перехватывал Tailscale на macOS.
